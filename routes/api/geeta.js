...
router.get('/category', async (req, res) => {
    try {
        ...
        const total = await GeetaCategory.countDocuments();
...
router.get('/category/:categoryId', async (req, res) => {
    try {
        ...
        const category = await GeetaCategory.findOne({ id: req.params.categoryId });
        if (!category) {
        ...
        const total = await GeetaName.countDocuments({ category: category._id });
...
router.get('/category/:categoryId/:nameId', async (req, res) => {
    try {
        ...
        const category = await GeetaCategory.findOne({ id: req.params.categoryId });
        const book = await GeetaName.findOne({ id: req.params.nameId });
        ...
        const total = await GeetaChapter.countDocuments({
            category: category._id,
            book: book._id
        });
...
router.get('/category/:categoryId/:nameId/:chapterId', async (req, res) => {
    try {
        ...
        const category = await GeetaCategory.findOne({ id: req.params.categoryId });
        const book = await GeetaName.findOne({ id: req.params.nameId });
        const chapter = await GeetaChapter.findOne({ id: req.params.chapterId });
        ...
        const content = await GeetaContent.find({
            category: category._id,
            book: book._id,
            chapter: chapter._id
        })
        ...
        const total = await GeetaContent.countDocuments({
            category: category._id,
            book: book._id,
            chapter: chapter._id
        });
...
router.get('/category/:categoryId/:nameId/:chapterId/:contentId', async (req, res) => {
    try {
        ...
        const content = await GeetaContent.findOne({
            category: category._id,
            book: book._id,
            chapter: chapter._id,
            $or: contentFilters
